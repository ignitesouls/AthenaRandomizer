...
$Event(0, Default, function() {
    ...
    RegisterBonfire(13000011, 13001961, 0, 0, 0, 5);
    $InitializeEvent(0, 13002805);
    $InitializeCommonEvent(0, 9005810, 13000830, 13000001, 13000951, 13001951, 5);
    $InitializeCommonEvent(0, 9005810, 13000850, 13000002, 13000952, 13001952, 5);
    $InitializeEvent(0, 13002500);
    $InitializeEvent(0, 13002800);
    $InitializeEvent(0, 13002810);
    $InitializeEvent(0, 13002811);
    $InitializeEvent(0, 13002829);
    $InitializeEvent(0, 13002820);
    $InitializeEvent(0, 13002827);
    $InitializeEvent(0, 13002828);
    $InitializeEvent(0, 13002819);
    $InitializeEvent(0, 13002830);
    $InitializeEvent(0, 13002834);
    $InitializeEvent(0, 13002835);
    $InitializeEvent(0, 13002840);
    $InitializeEvent(0, 13002841);
    $InitializeEvent(0, 13002849);
    $InitializeEvent(0, 13002850);
    $InitializeEvent(0, 13002860);
    $InitializeEvent(0, 13002861);
    $InitializeEvent(0, 13002865);
    ...
    $InitializeEvent(0, 13002646, 13000492, 13002492, 13000492, 10);
    $InitializeCommonEvent(0, 90005300, 13000494, 13000494, 0, 0, 0);
    $InitializeEvent(2, 13002493, 13000494, 13002645, 13002494);
    $InitializeEvent(1, 13002646, 13000494, 13002646, 13000494, 10);
    $InitializeEvent(0, 13002610);
    $InitializeCommonEvent(0, 90005300, 13000495, 13000495, 13002093, 0, 0);
    $InitializeEvent(2, 13002646, 13000495, 13002495, 13000495, 1);
    ...
    $InitializeCommonEvent(0, 90005300, 13000496, 13000496, 13002095, 2, 0);
    $InitializeEvent(0, 13002580);
    $InitializeEvent(0, 13002510);
    ...
    $InitializeEvent(1, 13002600, 13000600, 13002600, 13002121, 1);
    $InitializeEvent(2, 13002600, 13000600, 13002600, 13002122, 3);
    $InitializeEvent(3, 13002600, 13000600, 13002600, 13002123, 5);
    $InitializeEvent(4, 13002600, 13000600, 13002600, 13002124, 6);
    $InitializeEvent(5, 13002600, 13000600, 13002600, 13002125, 9);
    $InitializeEvent(6, 13002600, 13000600, 13002600, 13002126, 1);
    $InitializeEvent(7, 13002600, 13000600, 13002600, 13002127, 2.5);
    $InitializeEvent(8, 13002600, 13000600, 13002600, 13002128, 7);
    ...
    $InitializeCommonEvent(0, 90005780, 13000850, 13002160, 13002161, 13000720, SummonSignType.NPCWhiteSign, 13002721, 13002720, true, 0);
    $InitializeCommonEvent(0, 90005781, 13000850, 13002160, 13002161, 13000720);
    $InitializeEvent(0, 13002859);
    $InitializeCommonEvent(0, 90005780, 13000850, 13002164, 13002165, 13000725, SummonSignType.NPCWhiteSign, 13002726, 13002721, true, 0);
    ...
    $InitializeCommonEvent(0, 90005790, 0, 13000180, 13002181, 13002182, 13000710, 22, 13002180, 13002181, 0, 13009300, false, 0);
    ...
    $InitializeEvent(0, 13003720);
    $InitializeEvent(0, 13003721);
});

// プリコンストラクタ -- preconstructor
$Event(50, Default, function() {
    $InitializeEvent(0, 13000519);
    $InitializeCommonEvent(0, 90005201, 13000200, 30003, 20003, 2, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000201, 30003, 20003, 2, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000202, 30003, 20003, 2, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000252, 30003, 20003, 2, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005261, 13000203, 13002203, 20, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000204, 13002201, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000250, 13002201, 3.5, -1);
    ...
    $InitializeCommonEvent(0, 90005261, 13000206, 13002205, 10, 0, -1);
    $InitializeCommonEvent(0, 90005261, 13000209, 13002209, 10, 0, -1);
    $InitializeCommonEvent(0, 90005211, 13000207, 30003, 20003, 13002207, 3, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 13000210, 13002210, 0, 3001);
    $InitializeCommonEvent(0, 90005251, 13000210, 3, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000211, 13002207, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000212, 13002207, 1, -1);
    ...
    $InitializeCommonEvent(0, 90005261, 13000225, 13002225, 20, 0, -1);
    $InitializeCommonEvent(0, 90005210, 13000227, 30004, 20004, 13002227, 5, 0, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005261, 13000235, 13002235, 20, 0, -1);
    $InitializeCommonEvent(0, 90005251, 13000236, 5, 0, -1);
    $InitializeCommonEvent(0, 90005201, 13000237, 30004, 20004, 5, 0, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005251, 13000270, 40, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000260, 13002296, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000261, 13002296, 1, -1);
    $InitializeCommonEvent(0, 90005250, 13000262, 13002296, 0, -1);
    $InitializeCommonEvent(0, 90005261, 13000278, 13002278, 30, 0, -1);
    ...
    $InitializeCommonEvent(0, 90005200, 13000289, 30004, 20004, 13002289, 1, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000290, 30004, 20004, 13002289, 0.5, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005251, 13000417, 1, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000418, 13002418, 0, 3003);
    $InitializeCommonEvent(0, 90005250, 13000419, 13002418, 0.5, 3003);
    $InitializeCommonEvent(0, 90005261, 13000420, 13002420, 10, 0, -1);
    $InitializeCommonEvent(0, 90005200, 13000422, 30018, 20018, 13002421, 5.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000423, 30018, 20018, 13002421, 7.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000424, 30018, 20018, 13002421, 8, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005200, 13000451, 30014, 20014, 13002446, 3, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000452, 30014, 20014, 13002446, 1.5, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005261, 13000298, 13002323, 35, 0, -1);
    $InitializeCommonEvent(0, 90005261, 13000299, 13002323, 35, 0, -1);
    $InitializeCommonEvent(0, 90005200, 13000456, 30017, 20017, 13002456, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000457, 30018, 20018, 13002459, 1.5, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000458, 30018, 20018, 13002459, 2, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005200, 13000463, 30018, 20018, 13002463, 3, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000464, 30018, 20018, 13002463, 4, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005221, 13000474, 30018, 20018, 0, 0);
    $InitializeCommonEvent(0, 90005251, 13000460, 3, 0, -1);
    $InitializeCommonEvent(0, 90005250, 13000481, 13002481, 0, 3003);
    $InitializeCommonEvent(0, 90005250, 13000482, 13002418, 0.5, 3003);
    $InitializeCommonEvent(0, 90005200, 13000485, 30017, 20017, 13002435, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000487, 30017, 20017, 13002435, 3, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000488, 30017, 20017, 13002488, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005261, 13000489, 13002488, 2, 0.5, -1);
    $InitializeCommonEvent(0, 90005200, 13000300, 30001, 20001, 13002300, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000310, 30000, 20000, 10, 0, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005261, 13000314, 13002314, 20, 0, -1);
    $InitializeCommonEvent(0, 90005201, 13000315, 30000, 20000, 20, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000315, 30000, 20000, 15, 0, 0, 1, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005210, 13000356, 30000, 20000, 13002356, 9, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005210, 13000357, 30000, 20000, 13002356, 9, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005210, 13000358, 30000, 20000, 13002356, 9, 0, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005200, 13000364, 30000, 20000, 13002362, 1, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005200, 13000365, 30001, 20001, 13002365, 0, 0, 1, 0, 0);
    $InitializeCommonEvent(0, 90005201, 13000367, 30000, 20000, 1, 0, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005251, 13000385, 10, 0, -1);
    ...
    $InitializeCommonEvent(0, 90005251, 13000386, 55, 6, -1);
    ...
    $InitializeCommonEvent(0, 90005261, 13000374, 13002374, 3, 0, -1);
    ...
    $InitializeCommonEvent(0, 90005261, 13000496, 13002496, 40, 0, -1);
});

// メリナ炎上後脱出封印 -- Escape seal after Melina burns
...
// 獣の末裔_ターゲットクリア_XX -- Descendant of the Beast_Target Clear_XX
$Event(13002236, Restart, function(areaEntityId, chrEntityId) {
    WaitFor(
...
// 守護末登場_XX -- Shugosue appears_XX
$Event(13002490, Restart, function(chrEntityId, areaEntityId, animationId, eventFlagId) {
...
// 守護者の末裔_ブレス連打_XX -- Descendant of the Guardian_Breath Consecutive Strike_XX
$Event(13002493, Restart, function(chrEntityId, areaEntityId, areaEntityId2) {
    ClearSpEffect(chrEntityId, 18941);
    WaitFor(
        ((CharacterType(10000, TargetType.BlackPhantom) && CharacterHasSpEffect(10000, 3710))
            || CharacterType(10000, TargetType.Alive)
            || CharacterType(10000, TargetType.GrayPhantom)
    ...
    SetSpEffect(chrEntityId, 18941);
    WaitFixedTimeSeconds(4);
    RestartEvent();
});

// 守護末の末裔_撤退_XX -- Descendant of the Last Guardian_Retreat_XX
$Event(13002646, Restart, function(eventFlagId, areaEntityId, chrEntityId, timeSeconds) {
    EndIf(EventFlag(eventFlagId));
    EndIf(ThisEventSlot());
    WaitFor(!InArea(10000, areaEntityId) && CharacterAIState(chrEntityId, AIStateType.Combat));
...
// 【専用】敵対NPC_帰還 -- [Exclusive] Hostile NPC_Return
$Event(13002660, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, npcEntityId, entityId, areaEntityId, value) {
    EndIf(EventFlag(eventFlagId));
    EndIf(!PlayerIsInOwnWorld());
    flag = EventFlag(eventFlagId);
    flagArea &= EventFlag(eventFlagId2);
    if (areaEntityId == 0) {
        flagArea &= !EntityInRadiusOfEntity(10000, entityId, 110, 1);
    } else {
        flagArea &= !InArea(10000, areaEntityId);
    }
    flagArea2 &= EventFlag(eventFlagId2);
    if (Signed(value) != 2) {
        GotoIf(S0, Signed(value) == 1);
        flagArea2 &= !EntityInRadiusOfEntity(10000, entityId, 180, 1);
        Goto(S1);
S0:
        flagArea2 &= !EntityInRadiusOfEntity(10000, entityId, 360, 1);
    } else {
        flagArea2 &= !EntityInRadiusOfEntity(10000, entityId, 720, 1);
    }
S1:
...
L0:
    ...
    SetNetworkconnectedEventFlagID(13000800, ON);
    SetEventFlagID(9116, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61116, ON);
    }
    EndIf(!PlayerIsInOwnWorld());
    EndIf(PlayerIsInOwnWorld());
});

// マリケス用篝火処理 -- Bonfire processing for Marikes
...
// マリケス柱内復帰ワープ処理 -- Marikes pillar return warp processing
...
// マリケス壁キック用イベントターゲット設定 -- Event target setting for Marikes wall kick
...
// マリケス柱内復帰処理 -- Marikes pillar return process
...
// マリケス柱内復帰処理_完了 -- Marikes pillar return process_completed
...
// マリケスボスイベント起動 -- Marikes boss event started
...
// 古龍撃破 -- Defeat the ancient dragon
$Event(13002830, Restart, function() {
    ...
    SetEventFlagID(13000830, ON);
    SetEventFlagID(9115, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61115, ON);
    }
    if (PlayerIsInOwnWorld()) {
...
// 古龍ボス部屋へワープする -- Warp to the Elder Dragon boss room
...
// 古龍カメラ変更イベント -- Old dragon camera change event
...
// 古龍用ゲストがボス部屋入場 -- Ancient dragon guest enters boss room
$Event(13002846, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    DisableNetworkSync();
    EndIf(EventFlag(eventFlagId));
    WaitFor(
...
// 古龍ボスイベント起動 -- Ancient dragon boss event started
...
// 【専用】協力NPC_ボス部屋入場 -- [Exclusive] Cooperating NPC_Boss room entry
...
// 神肌復活カウントダウン_XX -- God skin revival countdown_XX
$Event(13002890, Restart, function(eventFlagId, chrEntityId, chrEntityId2, spEffectId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(13000850));
...
// 神肌復活_XX -- Divine skin revival_XX
$Event(13002891, Restart, function(eventFlagId, generatorEntityId, chrEntityId, spEffectId, chrEntityId2, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(13000850));
    EndIf(EventFlag(13002854));
    WaitFor(
        (CharacterHasSpEffect(chrEntityId, spEffectId) || CharacterDead(chrEntityId))
            && EventFlag(eventFlagId));
    EndIf(EventFlag(13000850));
    EndIf(EventFlag(13002854));
...
// 神肌復活_両方死亡 -- God skin resurrection_both dead
...
// 神肌ボスイベント起動 -- Divine skin boss event started
...
// 落雷演出_XX -- Lightning strike_XX
$Event(13002600, Restart, function(chrEntityId, areaEntityId, entityId, timeSeconds) {
    EndIf(EventFlag(13000490));
    CreateBulletOwner(chrEntityId);
    WaitFor(InArea(10000, areaEntityId));
    WaitFixedTimeSeconds(0.1);
    WaitFixedTimeSeconds(timeSeconds);
    SpawnOneshotSFX(TargetEntityType.Area, entityId, -1, 813600);
    WaitFixedTimeSeconds(5);
    RestartEvent();
});

// 守護末落雷 -- Thunderbolt at the end of the guardian
...
// NPC202_マリケス_会話処理限界延長 -- NPC202_Marikes_Conversation processing limit extension
...
// 壺マイヤー_NPC初期化イベント_最後の戦い -- Tsubo Meyer_NPC initialization event_Last battle
$Event(13003710, Restart, function(chrEntityId) {
...
L1:
    ...
    if (EventFlag(13009258)) {
        ForceAnimationPlayback(chrEntityId, 930014, false, false, false);
    }
    DisableCharacter(13000701);
...
// 壺マイヤー_最後の戦い -- Tsubomayer_The Last Battle
$Event(13003711, Restart, function(chrEntityId) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(EventFlag(3671) && EventFlag(13009256));
    SetCharacterTalkRange(chrEntityId, 200);
    if (EventFlag(13009258)) {
...
L1:
    ...
    flagHp &= CharacterHPValue(chrEntityId) == 1;
    WaitFor(flagHp);
    SetNetworkconnectedEventFlagID(13002712, ON);
    ForceAnimationPlayback(chrEntityId, 20035, false, false, false);
L2:
...
// NPC326_火山館最強の騎士_闇霊侵入許可フラグ立て -- NPC326_Volcano Pavilion's Strongest Knight_Dark Spirit Intrusion Permission Flag Set
...
// NPC326_火山館最強の騎士_白霊共闘許可フラグ立て -- NPC326_Volcano Pavilion's Strongest Knight_White Spirit Collaboration Permission Flag Raised
