...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 9005810, 12020850, 71221, 12020951, 12021951, 5);
    $InitializeCommonEvent(0, 9005810, 12020800, 71220, 12020950, 12021950, 5);
    $InitializeEvent(0, 12022503);
    $InitializeEvent(0, 12022580);
    ...
    $InitializeEvent(0, 12022800);
    $InitializeEvent(0, 12022810);
    $InitializeEvent(0, 12022849);
    $InitializeEvent(0, 12022820);
    $InitializeEvent(0, 12022821);
    $InitializeEvent(0, 12022850);
    $InitializeEvent(0, 12022860);
    $InitializeEvent(0, 12022865, 12020860, 12020850, 63010);
    $InitializeEvent(0, 12022899);
    ...
    $InitializeEvent(0, 12020510);
    $InitializeEvent(0, 12022670);
    $InitializeCommonEvent(0, 90005605, 12021203, 12, 2, 0, 0, 12022203, 12020000, 12022203, 12022210, 12022211, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005605, 12021204, 12, 2, 0, 0, 12022204, 12020000, 12022204, 12022212, 12022213, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005605, 12021205, 12, 2, 0, 0, 12022205, 12020000, 12022205, 12022215, 12022206, 0, 0, 0, 0);
    $InitializeEvent(0, 12022600);
    $InitializeEvent(0, 12022609);
    $InitializeEvent(0, 12022620);
    $InitializeEvent(0, 12022629);
    ...
    $InitializeCommonEvent(0, 90005261, 12020220, 12022220, 70, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12020221, 12022220, 70, 0, -1);
    ...
    $InitializeCommonEvent(0, 90005250, 12020310, 12022305, 2, 3011);
    ...
    $InitializeCommonEvent(0, 90005251, 12020340, 6, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020341, 6, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020342, 6, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020343, 6, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020344, 6, 0, -1);
    ...
    $InitializeEvent(23, 12022300, 12020336, 12022336, 3);
    ...
    $InitializeCommonEvent(0, 90005201, 12020376, 30011, 20011, 4, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 12020377, 30011, 20011, 4, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 12020378, 30011, 20011, 7, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 12020379, 30011, 20011, 7, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005251, 12020348, 100, 0, -1);
    $InitializeEvent(0, 12022350, 12020390, 12025350);
    $InitializeEvent(0, 12022360, 12020390, 12025350);
    $InitializeEvent(0, 12022370);
    $InitializeEvent(0, 12022371);
    $InitializeCommonEvent(0, 90005250, 12020390, 12022350, 3, -1);
    $InitializeEvent(0, 12022372);
    $InitializeEvent(0, 12022373);
    ...
    $InitializeCommonEvent(0, 90005250, 12020350, 12022350, 3, -1);
    ...
    $InitializeCommonEvent(0, 90005251, 12020471, 30, 0, 3009);
    $InitializeCommonEvent(0, 90005300, 12020470, 12020470, 40648, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020472, 12020472, 40630, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020474, 12020474, 40610, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020477, 12020477, 40642, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020479, 12020479, 40646, 1.5, 0);
    $InitializeCommonEvent(0, 90005250, 12020420, 12022420, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020421, 60, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020424, 100, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12020422, 12022422, 45, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020424, 60, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12020431, 10, 0, -1);
    $InitializeCommonEvent(0, 90005300, 12020430, 12020430, 12020435, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020431, 12020431, 12020445, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12020434, 12020434, 0, 1.5, 0);
    $InitializeCommonEvent(0, 90005261, 12020440, 12022440, 15, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12020442, 12022442, 15, 0, -1);
    ...
    $InitializeCommonEvent(0, 90005250, 12020450, 12022450, 1.5, -1);
    $InitializeCommonEvent(0, 90005250, 12020451, 12022450, 2, -1);
    $InitializeCommonEvent(0, 90005250, 12020452, 12022450, 3, -1);
    $InitializeCommonEvent(0, 90005250, 12020453, 12022450, 2.5, -1);
    $InitializeCommonEvent(0, 90005250, 12020454, 12022450, 0, -1);
    $InitializeCommonEvent(0, 90005250, 12020455, 12022450, 0, -1);
    $InitializeCommonEvent(0, 90005251, 12025461, 20, 0, -1);
    $InitializeEvent(0, 12022419, 12020400, 12020490, 12022400);
    $InitializeEvent(1, 12022400, 12020380, 12020491, 12022401);
    $InitializeCommonEvent(0, 90005261, 12020380, 12022411, 20, 0, -1);
    $InitializeEvent(2, 12022400, 12020402, 12020492, 12022402);
    $InitializeCommonEvent(0, 90005261, 12020402, 12022412, 20, 0, -1);
    ...
    $InitializeEvent(0, 12023721, 12021701, 3, 9710, 1034509410);
    ...
    $InitializeCommonEvent(0, 90005780, 12020800, 12022160, 12022161, 12020715, SummonSignType.NPCWhiteSign, 12022716, 12029019, true, 0);
    $InitializeCommonEvent(0, 90005781, 12020800, 12022160, 12022161, 12020715);
    $InitializeEvent(0, 12022699);
    $InitializeEvent(0, 12022698);
});
...
// 敵壁暫定消去 -- Enemy wall temporary deletion
...
// 平原エレベータ_ガーゴイル像で初回起動 -- Plains Elevator_First activation with gargoyle statue
$Event(12022569, Restart, function(eventFlagId, eventFlagId2) {
    DisableNetworkSync();
...
// ガーゴイル像_封印扉 -- Gargoyle statue_sealed door
$Event(12022568, Default, function(eventFlagId, assetEntityId) {
    DisableNetworkSync();
...
// 消費鍵のガーゴイル像_ギミック制御 -- Gargoyle statue of consumption key_gimmick control
$Event(12022567, Default, function(eventFlagId, areaEntityId) {
    DisableNetworkSync();
...
// 下層灯火台イベント -- Lower lighthouse event
...
// 下層灯火点火イベント_XX -- Lower level light ignition event_XX
$Event(12022601, Restart, function(eventFlagId, assetEntityId, assetEntityId2) {
    if (EventFlag(eventFlagId)) {
        DeleteAssetfollowingSFX(assetEntityId, true);
        DeleteAssetfollowingSFX(assetEntityId2, true);
        CreateAssetfollowingSFX(assetEntityId, 200, 812070);
        CreateAssetfollowingSFX(assetEntityId, 201, 812070);
        CreateAssetfollowingSFX(assetEntityId2, 200, 812070);
        EndEvent();
    }
L0:
    EnableCharacterCollision(10000);
    if (PlayerIsInOwnWorld()) {
        WaitFor(ActionButtonInArea(9524, assetEntityId) && PlayerIsInOwnWorld());
...
// 下層祖霊部屋へワープ -- Warp to the lower ancestral spirit room
$Event(12022609, Default, function() {
    if (PlayerIsInOwnWorld()) {
        if (EventFlag(12020609)) {
            ...
            WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12082400, -1, 0, false, true);
...
L10:
    ...
    WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12022202, -1, 0, false, true);
    WaitFixedTimeSeconds(5);
    WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12082401, -1, 0, false, true);
    RestartEvent();
});

// 上層灯火台イベント -- Upper lighthouse event
...
// 上層灯火点火イベント_XX -- Upper light ignition event_XX
$Event(12022621, Restart, function(eventFlagId, assetEntityId, assetEntityId2) {
    if (EventFlag(eventFlagId)) {
        DeleteAssetfollowingSFX(assetEntityId, true);
        DeleteAssetfollowingSFX(assetEntityId2, true);
        CreateAssetfollowingSFX(assetEntityId, 200, 812070);
...
// 上層祖霊部屋へワープ -- Warp to the upper ancestral spirit room
$Event(12022629, Default, function() {
    if (PlayerIsInOwnWorld()) {
        if (EventFlag(12020629)) {
            ...
            WaitFixedTimeSeconds(2);
            WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12092400, -1, 0, false, true);
            WaitFixedTimeFrames(1);
            RestartEvent();
        }
L1:
...
L10:
    ...
    WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12022209, -1, 0, false, true);
    WaitFixedTimeSeconds(5);
    WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12092401, -1, 0, false, true);
    RestartEvent();
});

// マリカ遺跡２入り口へのワープ -- Warp to Marika Ruins 2 entrance
...
L6:
        ...
        WaitFixedTimeSeconds(3);
        WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12022670, -1, 10000, false, true);
        RestartEvent();
    }
L10:
    WaitFor(EventFlag(12022670));
    WaitFixedTimeSeconds(3);
    WarpCharacterAndCopyFloorWithFadeout(20000, TargetEntityType.Area, 12022671, -1, 10000, false, false);
    RestartEvent();
});
...
// 領域_特殊効果解除_XX -- Area_Special effect cancellation_XX
$Event(12022200, Restart, function(areaEntityId, chrEntityId, spEffectId) {
    EndIf(ThisEventSlot());
    WaitFor(
...
// マリカスライム参戦 -- Marika slime participation
...
// 祖霊信仰者_出現_XX -- Ancestral Spirit Believer_Appearance_XX
$Event(12022300, Restart, function(chrEntityId, areaEntityId, timeSeconds) {
    if (ThisEventSlot()) {
...
// 祖霊信仰者_バフ掛け_XX -- Ancestral Spirit Believer_Buffing_XX
$Event(12022350, Restart, function(chrEntityId, chrEntityId2) {
    WaitFor(
        EntityInRadiusOfEntity(chrEntityId, 10000, 60, 1) && CharacterHasSpEffect(chrEntityId, 5080));
    WaitFixedTimeFrames(30);
    SetSpEffect(chrEntityId2, 13190);
    WaitFixedTimeFrames(1);
    RestartEvent();
});

// 祖霊信仰者_バフ解除_XX -- Ancestral Spirit Believer_Buff Removal_XX
$Event(12022360, Restart, function(chrEntityId, chrEntityId2) {
    WaitFor(
        EntityInRadiusOfEntity(chrEntityId, 10000, 60, 1)
            && !CharacterHasSpEffect(chrEntityId, 5080));
    ClearSpEffect(chrEntityId2, 13190);
    WaitFixedTimeFrames(30);
    RestartEvent();
});

// 祖霊信仰者_踊りだす -- Ancestor spirit believer_begins to dance
...
// 祖霊信仰者_踊りやめ -- Ancestral spirit believers_stop dancing
...
// 祖霊信仰者_踊り中央 -- Ancestor Spirit Believers_Odori Chuo
...
// 祖霊信仰者_踊り最後 -- Ancestor spirit believers_last dance
...
// マリカスライム_NPC変身_XX -- Marika slime_NPC transformation_XX
$Event(12022400, Restart, function(chrEntityId, chrEntityId2, areaEntityId) {
...
L0:
    ...
    WaitFor(CharacterHasSpEffect(chrEntityId, 16307));
    ...
    ForceAnimationPlayback(chrEntityId2, 63010, false, false, true);
...
// マリカスライム_トロル変身_XX -- Marika Slime_Troll Transformation_XX
$Event(12022419, Restart, function(chrEntityId, chrEntityId2, areaEntityId) {
    if (CharacterDead(chrEntityId2)) {
        DisableCharacter(chrEntityId);
    }
    if (ThisEventSlot() && !PlayerIsInOwnWorld()) {
...
// バディ汎用_参戦_XX -- Buddy general purpose_participation_XX
$Event(12022440, Restart, function(chrEntityId, chrEntityId2, patrolInformationEntityId) {
    WaitFor(CharacterAIState(chrEntityId, AIStateType.Combat));
    RequestCharacterAIReplan(chrEntityId2);
    SetSpEffect(chrEntityId2, 5000);
    ChangeCharacterPatrolBehavior(chrEntityId2, patrolInformationEntityId);
});
...
// 石棺への導き -- Guide to the sarcophagus
...
// ガーゴイル像解放する前にレバーをロックする -- Lock the lever before releasing the gargoyle statue
...
// 前座ボス撃破 -- Defeat the undercard boss
$Event(12022850, Restart, function() {
    ...
    SetEventFlagID(12020850, ON);
    SetEventFlagID(9134, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(91134, ON);
    }
});

// 前座ボス出現 -- Undercard boss appears
...
// コピースライムNPC_ワープ出現 -- Copy Slime NPC_Warp Appears
$Event(12022865, Restart, function(chrEntityId, chrEntityId2, areaEntityId) {
    if (ThisEventSlot() && !PlayerIsInOwnWorld()) {
        DisableCharacter(chrEntityId);
        DisableCharacterCollision(chrEntityId);
        EndEvent();
...
// ホストがボス部屋入場_スライムボス用 -- Host enters boss room_for slime boss
$Event(12022869, Restart, function(eventFlagId, entityId, areaEntityId, eventFlagId2, chrEntityId, actionButtonParameterId, eventFlagId3, areaEntityId2) {
    if (!EventFlag(eventFlagId)) {
        WaitFixedTimeFrames(1);
        if (eventFlagId3 != 0) {
...
// 前座ボス_イベント起動 -- Undercard boss_event activation
...
$Event(12022800, Restart, function() {
    ...
    SetEventFlagID(12020800, ON);
    SetEventFlagID(9110, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61110, ON);
    }
});
...
// 本ボス_乱入イベント -- Main boss_intrusion event
...
// 本ボス_２体判定イベント -- This boss_2 body judgment event
...
$Event(12020700, Restart, function(chrEntityId, assetEntityId, assetEntityId2) {
    DisableNetworkSync();
    WaitFixedTimeFrames(1);
    if (PlayerIsInOwnWorld()) {
        if (EventFlag(4060)) {
...
L0:
    ...
    ForceAnimationPlayback(chrEntityId, 90107, false, false, false);
...
// NPC319ダニー_白霊召喚リアルタイム状態遷移 -- NPC319 Danny_White Spirit Summon Real-time state transition
$Event(12020701, Restart, function(entityId) {
    EndIf(!PlayerIsInOwnWorld());
...
// しゃべスラ_ダミー_NPC初期化イベント -- Chatsura_dummy_NPC initialization event
$Event(12023710, Restart, function(chrEntityId, chrEntityId2) {
    WaitFixedTimeFrames(1);
    DisableCharacter(chrEntityId);
    SetCharacterBackreadState(chrEntityId, true);
    DisableCharacter(chrEntityId2);
...
// しゃべスラ_聖杯に接近 -- Shabesura_Approaching the Holy Grail
$Event(12023711, Restart, function(entityId, eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(3503));
    EndIf(EventFlag(12029060));
    WaitFor(EntityInRadiusOfEntity(10000, entityId, 5, 1));
...
// NPC216狼頭の戦士_初期化イベント_地下迷宮で探索 -- NPC216 Wolf-headed Warrior_Initialization event_Explore in the underground labyrinth
$Event(12023720, Restart, function(chrEntityId) {
    DisableNetworkSync();
    WaitFixedTimeFrames(1);
    if (PlayerIsInOwnWorld()) {
        if (EventFlag(3600)) {
...
// NPC106ラニ_仲間になるまで秘宝入手不可 -- NPC106 Rani_Unable to obtain secret treasure until you become a friend
$Event(12023721, Restart, function(entityId, targetDistance, spEffectId, eventFlagId) {
    DisableNetworkSync();
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(EventFlag(eventFlagId) && EntityInRadiusOfEntity(10000, entityId, targetDistance, 1));
