...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90005261, 12030200, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12030210, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12030211, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12030212, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12030213, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005261, 12030214, 12032200, 50, 0, -1);
    $InitializeCommonEvent(0, 90005300, 12030240, 12030240, 12030800, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030241, 12030241, 12030810, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030256, 12030256, 12030820, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030257, 12030257, 12030830, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030297, 12030297, 12030840, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030201, 12030201, 12030850, 1.5, 0);
    $InitializeCommonEvent(0, 90005251, 12030303, 8, 0, -1);
    $InitializeCommonEvent(0, 90005300, 12030350, 12030350, 40660, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030354, 12030354, 40668, 1.5, 0);
    $InitializeCommonEvent(0, 90005300, 12030355, 12030355, 40670, 1.5, 0);
    ...
    $InitializeCommonEvent(0, 90005300, 12030391, 12030391, 12030960, 1.5, 0);
    $InitializeCommonEvent(0, 90005250, 12030391, 12032391, 0, -1);
    $InitializeEvent(0, 12032504);
    $InitializeEvent(0, 12032509);
    $InitializeCommonEvent(0, 90005251, 12030400, 200, 10, -1);
    ...
    $InitializeCommonEvent(1, 90005453, 12030400, 12031421, 61, 0.1);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031422, 62, 0.2);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031423, 63, 0.3);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031424, 64, 0.4);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031425, 65, 0.5);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031426, 66, 0.6);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031427, 67, 0.7);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031428, 68, 0.8);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031429, 69, 0.9);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031430, 70, 1);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031431, 71, 0.1);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031432, 72, 0.2);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031433, 73, 0.3);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031434, 74, 0.4);
    $InitializeCommonEvent(0, 90005453, 12030400, 12031435, 75, 0.5);
    ...
    $InitializeCommonEvent(0, 90005740, 12032715, 12032716, 12032717, 12030702, 702, 12031731, 702, 0.4, 90305, 90307, -1, 1.3);
    $InitializeCommonEvent(0, 90005741, 12032718, 12032719, 12032717, 12030702, 90330, 0, 90332, -1, 0.5);
    ...
    $InitializeCommonEvent(0, 90005740, 12032725, 12032726, 0, 12030700, 0, 0, 0, 1.3, 90305, 90307, -1, 1.3);
    $InitializeCommonEvent(0, 90005752, 12031730, 200, 120, 3);
...
// Warp to the capital after Fortisux is defeated
...
$Event(12032577, Restart, function() {
    EndIf(!PlayerIsInOwnWorld());
...
$Event(12032861, Restart, function() {
    ...
    WaitFor(
        CharacterHasSpEffect(20000, 14898)
            ...
            && EntityInRadiusOfEntity(12030850, 20000, 15, 1)
