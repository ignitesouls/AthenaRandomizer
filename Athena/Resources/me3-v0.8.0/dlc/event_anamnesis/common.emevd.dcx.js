...
$Event(0, Default, function() {
    ...
    InitializeEvent(20, 1600, 62080, 63080, 2047411690, 2047411691);
    InitializeEvent(21, 1600, 62081, 63081, 2048451690, 2048451691);
    InitializeEvent(22, 1600, 62082, 63082, 2048371690, 2048371691);
    InitializeEvent(23, 1600, 62083, 63083, 2046451690, 2046451691);
    InitializeEvent(24, 1600, 62084, 63084, 2052411690, 2052411691);
    ...
    InitializeEvent(0, 1706, 0);
    InitializeEvent(0, 1707, 0);
    InitializeEvent(0, 1708, 0);
    ...
    InitializeEvent(40, 1100, 9140, 10400, 0, 510400);
    InitializeEvent(41, 1100, 9141, 10410, 0, 510410);
    InitializeEvent(43, 1100, 9143, 10430, 0, 510430);
    InitializeEvent(44, 1100, 9144, 10440, 0, 510440);
    InitializeEvent(45, 1100, 9145, 10450, 0, 510450);
    InitializeEvent(46, 1100, 9146, 10460, 0, 510460);
    InitializeEvent(47, 1100, 9147, 10470, 0, 510470);
    InitializeEvent(48, 1100, 9148, 10480, 0, 510480);
    InitializeEvent(49, 1100, 9149, 10490, 0, 510490);
    InitializeEvent(50, 1100, 9150, 10500, 0, 510500);
    InitializeEvent(51, 1100, 9151, 10510, 0, 510510);
    InitializeEvent(52, 1100, 9152, 10520, 0, 510520);
    InitializeEvent(53, 1100, 9153, 10530, 0, 510530);
    InitializeEvent(54, 1100, 9154, 10540, 0, 510540);
    InitializeEvent(55, 1100, 9155, 10550, 0, 510550);
    InitializeEvent(56, 1100, 9156, 10560, 0, 510560);
    InitializeEvent(57, 1100, 9157, 10570, 0, 510570);
    InitializeEvent(58, 1100, 9158, 10580, 0, 510580);
    InitializeEvent(59, 1100, 9159, 10590, 0, 510590);
    InitializeEvent(60, 1100, 9160, 10600, 0, 510600);
    InitializeEvent(61, 1100, 9161, 10610, 0, 510610);
    InitializeEvent(62, 1100, 9162, 10620, 0, 510620);
    InitializeEvent(63, 1100, 9163, 10630, 0, 510630);
    InitializeEvent(64, 1100, 9164, 10640, 0, 510640);
    ...
    InitializeEvent(90, 1100, 9190, 10900, 0, 510900);
    ...
    InitializeEvent(70, 1200, 9270, 20700, 0, 520700);
    InitializeEvent(71, 1200, 9271, 20710, 0, 520710);
    InitializeEvent(72, 1200, 9272, 20720, 0, 520720);
    InitializeEvent(75, 1200, 9275, 20750, 0, 520750);
    InitializeEvent(76, 1200, 9276, 20760, 0, 520760);
    InitializeEvent(77, 1200, 9277, 20770, 0, 520770);
    InitializeEvent(80, 1200, 9280, 20800, 0, 520800);
    InitializeEvent(81, 1200, 9281, 20810, 0, 520810);
...
$Event(50, Default, function() {
    ...
    if (!EventFlag(2052)) {
        ...
        InitializeEvent(0, 4279, 0);
        InitializeEvent(0, 4299, 0);
        InitializeEvent(0, 4319, 0);
        InitializeEvent(0, 4339, 0);
        InitializeEvent(0, 4359, 0);
        InitializeEvent(0, 4379, 0);
        InitializeEvent(0, 4399, 0);
        InitializeEvent(0, 4419, 0);
        InitializeEvent(0, 4439, 0);
        InitializeEvent(0, 4459, 0);
        InitializeEvent(0, 4479, 0);
        InitializeEvent(0, 4499, 0);
        InitializeEvent(0, 4519, 0);
        InitializeEvent(0, 4579, 0);
    }
    ...
    InitializeEvent(41, 60701, 11109792, 60742);
    InitializeEvent(42, 60701, 11109793, 60743);
    InitializeEvent(43, 60701, 11109794, 60744);
    InitializeEvent(44, 60701, 11109795, 60745);
    InitializeEvent(45, 60701, 11109796, 60746);
    InitializeEvent(47, 60701, 11109798, 60748);
    InitializeEvent(48, 60701, 11109799, 60749);
    ...
    InitializeEvent(0, 4858, 400700, 2049399743, 2049392711, 107010);
    ...
    InitializeEvent(0, 4933, 320550, 69920, 2008031);
...
$Event(4519, Restart, function() {
    ...
    if (EventFlag(4503) && EventFlag(25000800) && !EventFlag(2051450800)) {
        BatchSetNetworkconnectedEventFlags(4500, 4504, OFF);
        SetNetworkconnectedEventFlagID(4502, ON);
        BatchSetNetworkconnectedEventFlags(4505, 4517, OFF);
        SetNetworkconnectedEventFlagID(4506, ON);
    }
...
$Event(4933, Restart, function(X0_4, X4_4, X8_4) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(X0_4) && EventFlag(X4_4));
    GotoIf(L0, EventFlag(X0_4));
    GotoIf(L1, EventFlag(X4_4));
    GotoIf(L5, PlayerHasItemIncludingBBox(ItemType.Goods, X8_4));
    WaitFor(EventFlag(X0_4) || EventFlag(X4_4) || PlayerHasItemIncludingBBox(ItemType.Goods, X8_4));
    RestartEvent();
L0:
    SetEventFlagID(X4_4, ON);
    EndEvent();
