...
def t460006100_x0():
    ...
    while True:
        ...
        assert (t460006100_x14(actionbutton1=6300, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000,
                flag6=6000))
        """State 3"""
        def WhilePaused():
            GiveSpEffectToPlayer(9640)
        assert t460006100_x3() or GetDistanceToPlayer() > 3
        """State 1"""
        assert t460006100_x15()
    """Unused"""
    """State 4"""
    return 0
...
def t460006100_x3():
    ...
    while True:
        ...
        AddTalkListData(4, 21020000, -1)
        # action:23200000:"Spirit Tuning"
        AddTalkListData(5, 23200000, -1)
        # action:30000000:"Starlight Shop"
        AddTalkListData(6, 30000000, -1)
        # action:20000011:"Sell"
        AddTalkListData(7, 20000011, -1)
        ...
        if GetTalkListEntryResult() == 1:
            """State 4"""
            OpenRegularShop(9100000, 9199999)
            ...
            OpenBuddyUpgradeMenu()
            RecordPlayLog(23)
            assert not (CheckSpecificPersonMenuIsOpen(23, 0) and not CheckSpecificPersonGenericDialogIsOpen(0))
        elif GetTalkListEntryResult() == 6:
            """State 7"""
            OpenPuppetShop(9200000, 9299999)
...
def t460006100_x4():
    ...
    if call.Get() == 0:
        ...
        if GetTalkListEntryResult() == 0 or GetTalkListEntryResult() == 99:
            ...
            """State 9"""
            assert (t460006100_x12(val1=2008900, z1=6000, z2=6000, z3=6000, z4=6000, z5=26002210 + GetTalkListEntryResult()
                    - 60))
        else:
            """State 6"""
            assert t460006100_x5(val2=8910, z6=6000, z7=6000, z8=6000, z9=6000, z10=26001109 + GetTalkListEntryResult())
    elif call.Done():
        """State 8"""
        # action:26001001:"No bell bearing to offer"
        assert t460006100_x16(action1=26001001)
    """State 10"""
    return 0

def t460006100_x5(val2=8910, z6=6000, z7=6000, z8=6000, z9=6000, z10=_):
    """State 0,2"""
    PlayerEquipmentQuantityChange(3, val2 + GetTalkListEntryResult() - 1, -1)
    """State 3"""
    SetEventFlag(11109709 + GetTalkListEntryResult(), 1)
    """State 1,4"""
    assert t460006100_x16(action1=z10)
    """State 5"""
    return 0
...
def t460006100_x14(actionbutton1=6300, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t460006100_x16(action1=26001001):
    """State 0,1"""
    # action:26001001:"No bell bearing to offer"
